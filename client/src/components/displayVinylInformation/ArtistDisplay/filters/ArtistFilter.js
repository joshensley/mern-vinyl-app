            ...
            <Row>
                ...
                <Col xs="12" sm="12" style={{textAlign: "center", display:"inline-block"}}>
                    <Button 
                        ...
                        >
                           <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-filter-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zM3.5 5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zM5 8.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm2 3a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 0 1h-1a.5.5 0 0 1-.5-.5z"/>
                            </svg>{' '}
                            Filters
                    </Button>{' '}
